...
@Component({
  selector: 'app-reactive-forms-submit-touched',
  templateUrl: './reactive-forms-submit-touched.component.html',
  styleUrls: ['./reactive-forms-submit-touched.component.css']
})
export class ReactiveFormsSubmitTouchedComponent implements OnInit {
  ...
  // convenience getter for easy access to form fields
	...
	isAddressValidInput(fieldName): boolean {
		return this.userForm.get('address')['controls'][fieldName].touched;
	}
